...
function App() {
  ...
  const [feedback, setFeedback] = useState(`Click BUY to mint your Lucky Tiger.`);
  ...
  return (
    <s.Screen>
      ...
      >
        <StyledLogo alt={"Leap into Prosperity"} src={"/config/images/logo.png"} />
        <img
          style={{
            maxWidth: "100%",
          }}
        ...
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%", maxWidth: "540px" }}>
          ...
          >
            ...
            successfully mint your Lucky Tiger. We recommend that you don't lower the
            gas limit.
          </s.TextDescription>
        </s.Container>
      </s.Container>
